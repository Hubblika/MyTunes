        ...
        <div class="relative z-10 flex min-h-screen items-center justify-center p-6">
            <div class="flex w-full max-w-sm flex-col items-center gap-6 text-center">
                <img :src="logoSrc" alt="Logo"
                    class="h-32 w-auto select-none opacity-90 dark:opacity-100 drop-shadow-sm dark:drop-shadow-[0_0_12px_rgba(255,255,255,0.15)]" />

                <div
                    class="w-full rounded-2xl border border-black/10 dark:border-white/10 bg-white/80 dark:bg-white/5 backdrop-blur-xl px-8 py-10 shadow-xl dark:shadow-2xl shadow-black/10 dark:shadow-black/40">
                    ...
                    <Form v-bind="currentStore.form()" :reset-on-success="['password']" v-slot="{ processing, errors }"
                        ...
                        <div class="flex flex-col gap-1">
                            <Input id="email" type="email" required autofocus
                                ...
                                input-class="w-full rounded-xl bg-white dark:bg-black/30 border border-black/10 dark:border-white/10 px-4 py-3 focus:border-cyan-500/60 focus:ring-2 focus:ring-cyan-500/30 transition">
                        ...
                        <div class="flex flex-col gap-1">
                            <Input v-model="password" id="password" type="password" required
                                ...
                                input-class="w-full rounded-xl bg-white dark:bg-black/30 border border-black/10 dark:border-white/10 px-4 py-3 focus:border-fuchsia-500/60 focus:ring-2 focus:ring-fuchsia-500/30 transition">
                        ...
                        <PrimaryButton type="submit" :disabled="processing"
                            class="group relative mt-6 overflow-hidden rounded-xl bg-linear-to-r from-fuchsia-500 to-cyan-400 px-6 py-3 font-medium text-black transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-cyan-400/30 disabled:opacity-60 disabled:hover:translate-y-0">
                    ...
                    <span class="mt-6 block text-center text-sm text-neutral-600 dark:text-white/60">
                        ...
                        <TextLink @click="() => router.get(register ? '/login' : '/register')"
                            class="ml-1 font-medium text-cyan-600 dark:text-cyan-400 hover:text-fuchsia-500 dark:hover:text-fuchsia-400 transition-colors">
